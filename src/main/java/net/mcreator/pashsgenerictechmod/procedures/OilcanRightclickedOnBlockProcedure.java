...
public class OilcanRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == PashsGenericTechModModItems.OILCAN
				.get()
			...
			if ((world
					.getFluidState(new BlockPos(
							...
							entity.level
									.clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(5)),
											ClipContext.Block.OUTLINE, ClipContext.Fluid.SOURCE_ONLY, entity))
									.getBlockPos().getZ()))
					.createLegacyBlock()).getBlock() == PashsGenericTechModModBlocks.OIL.get()) {
				...
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(PashsGenericTechModModItems.OILCANFULL.get());
