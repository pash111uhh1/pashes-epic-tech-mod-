...
import net.mcreator.pashsgenerictechmod.network.TeleportguiButtonMessage;
...
public class TeleportguiScreen extends AbstractContainerScreen<TeleportguiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("pashs_generic_tech_mod:textures/teleportgui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "fuel", 78, 25, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 51, this.topPos + 61, 72, 20, new TextComponent("teleport!"), e -> {
			if (true) {
				PashsGenericTechModMod.PACKET_HANDLER.sendToServer(new TeleportguiButtonMessage(0, x, y, z));
