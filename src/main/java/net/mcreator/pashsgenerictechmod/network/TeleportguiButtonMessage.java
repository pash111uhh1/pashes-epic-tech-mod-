...
import net.mcreator.pashsgenerictechmod.procedures.MewheniteleportProcedure;
...
public class TeleportguiButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			MewheniteleportProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		PashsGenericTechModMod.addNetworkMessage(TeleportguiButtonMessage.class, TeleportguiButtonMessage::buffer, TeleportguiButtonMessage::new,
				TeleportguiButtonMessage::handler);
	}
}
